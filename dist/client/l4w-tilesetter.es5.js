...
var L4W_tilesetter = function (e) {
  ...
  !function (e) {
    ...
    e.update = function (e, n, r, i, o) {
      ...
      if (!c.a.isEmpty(i.movementStartTime)) {
        ...
        switch (_e5) {
          case 3:
            E = Math.min(r.cellW, Math.floor(l(i) * p)), b = E, E *= -1;
            break;

          case 1:
            E = Math.min(r.cellW, Math.floor(l(i) * p)), b = E;
            break;

          case 0:
            _ = Math.min(r.cellH, Math.floor(l(i) * p)), b = _, _ *= -1;
            break;

          case 2:
            _ = Math.min(r.cellH, Math.floor(l(i) * p)), b = _;
            break;
        ...
        if (4 !== _e5 && (void 0 !== i.states[i.currentState] && (i.states[i.currentState].direction = _e5), i.movementDirection = _e5, i.position = {
          ...
          i.i = _e6.i, i.j = _e6.j, u(E, _), (!c.a.isEmpty(i.newTarget) || i.position.x === i.target.x && i.position.y === i.target.y) && n(i);
        }
      }
  ...
  (function (e, n) {
    ...
    var Ae = function Ae(e) {
      ...
      }(e, we, Te), this.observeArray(e)) : this.walk(e);
    };

    function ke(e, t) {
      var n;
      if (l(e) && !(e instanceof ge)) return _(e, "__ob__") && e.__ob__ instanceof Ae ? n = e.__ob__ : Se && !oe() && (Array.isArray(e) || u(e)) && Object.isExtensible(e) && !e._isVue && (n = new Ae(e)), t && n && n.vmCount++, n;
    }
    ...
    function xe(e, t, n, r, i) {
      ...
      if (!a || !1 !== a.configurable) {
        ...
        Object.defineProperty(e, t, {
          ...
          get: function get() {
            var t = s ? s.call(e) : n;
            return fe.target && (o.depend(), c && (c.dep.depend(), Array.isArray(t) && Oe(t))), t;
          },
          set: function set(t) {
            var r = s ? s.call(e) : n;
    ...
    function Le(e, t) {
      ...
      for (var n, r, i, o = ce ? Reflect.ownKeys(t) : Object.keys(t), a = 0; a < o.length; a++) {
        "__ob__" !== (n = o[a]) && (r = e[n], i = t[n], _(e, n) ? r !== i && u(r) && u(i) && Le(r, i) : Me(e, n, i));
      }
    ...
    function Tt(e, t, n, r, i) {
      ...
      return i && r && !B.keyCodes[t] ? wt(i, r) : o ? wt(o, e) : r ? k(r) !== t : void 0;
    }
    ...
    function Lt(e) {
      e._o = At, e._n = v, e._s = h, e._l = bt, e._t = Et, e._q = $, e._i = R, e._m = Ct, e._f = _t, e._k = Tt, e._b = St, e._v = be, e._e = ye, e._u = It, e._g = Mt, e._d = Ot, e._p = Dt;
    }
    ...
    var jt = {
      ...
      prepatch: function prepatch(e, t) {
        ...
        !function (e, t, n, i, o) {
          ...
          e.$options._parentListeners = n, Kt(e, n, v), c && (e.$slots = ht(o, i.context), e.$forceUpdate());
          0;
        ...
        if (l(e) && (e = u.extend(e)), "function" == typeof e) {
          ...
          if (i(e.cid) && void 0 === (e = function (e, t) {
            ...
            if (n && !o(e.owners)) {
              ...
              return l(v) && (p(v) ? i(e.resolved) && v.then(f, h) : p(v.component) && (v.component.then(f, h), o(v.error) && (e.errorComp = Gt(v.error, t)), o(v.loading) && (e.loadingComp = Gt(v.loading, t), 0 === v.delay ? e.loading = !0 : c = setTimeout(function () {
          ...
          if (a(e.options.functional)) return function (e, t, n, i, a) {
            ...
            var d = new Nt(n, l, a, i, e),
                f = s.render.call(null, d._c, d);
            if (f instanceof ge) return $t(f, n, d.parent, s, d);

            if (Array.isArray(f)) {
              for (var p = dt(f) || [], h = new Array(p.length), v = 0; v < p.length; v++) {
                h[v] = $t(p[v], n, d.parent, s, d);
              }
    ...
    function Kt(e, t, n) {
      Ut = e, lt(t, n || {}, zt, Yt, Jt, e), Ut = void 0;
    }
    ...
    function bn(e, t, n) {
      var r = !oe();
      "function" == typeof n ? (vn.get = r ? En(t) : _n(n), vn.set = D) : (vn.get = n.get ? r && !1 !== n.cache ? En(t) : _n(n.get) : D, vn.set = n.set || D), Object.defineProperty(e, t, vn);
    }
    ...
    function Sn(e) {
      ...
      if (e["super"]) {
        ...
        if (n !== e.superOptions) {
          ...
          r && I(e.extendOptions, r), (t = e.options = Fe(n, e.extendOptions)).name && (t.components[t.name] = e);
        }
      }
    ...
    !function (e) {
      ...
      Object.defineProperty(e.prototype, "$data", t), Object.defineProperty(e.prototype, "$props", n), e.prototype.$set = Me, e.prototype.$delete = Ie, e.prototype.$watch = function (e, t, n) {
      ...
      KeepAlive: {
        ...
        render: function render() {
          ...
          if (n) {
            ...
            a[l] ? (t.componentInstance = a[l].componentInstance, b(s, l), s.push(l)) : (a[l] = t, s.push(l), this.max && s.length > parseInt(this.max) && In(a, s[0], s, this._vnode)), t.data.keepAlive = !0;
          }
    ...
    !function (e) {
      ...
      }), e.options._base = e, I(e.options.components, Dn), function (e) {
        e.use = function (e) {
    ...
    function vr(e, t) {
      ...
      if (!(o(n) && !1 === n.Ctor.options.inheritAttrs || i(e.data.attrs) && i(t.data.attrs))) {
        ...
        for (r in (Q || Z) && c.value !== l.value && gr(s, "value", c.value), l) {
          i(c[r]) && (Bn(r) ? s.removeAttributeNS(Pn, Hn(r)) : Rn(r) || s.removeAttribute(r));
        }
      }
    }

    function gr(e, t, n) {
      e.tagName.indexOf("-") > -1 ? mr(e, t, n) : Fn(t) ? Un(n) ? e.removeAttribute(t) : (n = "allowfullscreen" === t && "EMBED" === e.tagName ? "true" : t, e.setAttribute(t, n)) : Rn(t) ? e.setAttribute(t, function (e, t) {
        return Un(t) || "false" === t ? "false" : "contenteditable" === e && jn(t) ? t : "true";
      }(t, n)) : Bn(t) ? Un(n) ? e.removeAttributeNS(Pn, Hn(t)) : e.setAttributeNS(Pn, t, n) : mr(e, t, n);
    }
    ...
    function Wr(e, t) {
      var n = function (e) {
        if (e = e.trim(), Er = e.length, e.indexOf("[") < 0 || e.lastIndexOf("]") < Er - 1) return (Tr = e.lastIndexOf(".")) > -1 ? {
          exp: e.slice(0, Tr),
          key: '"' + e.slice(Tr + 1) + '"'
        } : {
          exp: e,
    ...
    function zr(e) {
      ...
      for (Sr = Tr; !Vr();) {
        if (qr(e = Gr())) Yr(e);else if (91 === e && t++, 93 === e && t--, 0 === t) {
          Cr = Tr;
          break;
        }
      }
    ...
    function ei(e, t) {
      if (!i(e.data.on) || !i(t.data.on)) {
        ...
        }(n), lt(n, r, Xr, Zr, Kr, t.context), Jr = void 0;
      }
    }
      ...
      if (!(i(n.staticStyle) && i(n.style) && i(r.staticStyle) && i(r.style))) {
        ...
        var p = function (e, t) {
          ...
          if (t) for (var i = e; i.componentInstance;) {
            (i = i.componentInstance._vnode) && i.data && (n = si(i.data)) && I(r, n);
          }
          (n = si(e.data)) && I(r, n);

          for (var o = e; o = o.parent;) {
            o.data && (n = si(o.data)) && I(r, n);
          }
    ...
    function Ei(e) {
      if (e) {
        if ("object" == _typeof(e)) {
          var t = {};
          return !1 !== e.css && I(t, _i(e.name || "v")), I(t, e), t;
        }
    ...
    wi && (void 0 === window.ontransitionend && void 0 !== window.onwebkittransitionend && (Ti = "WebkitTransition", Si = "webkitTransitionEnd"), void 0 === window.onanimationend && void 0 !== window.onwebkitanimationend && (Ci = "WebkitAnimation", Ai = "webkitAnimationEnd"));
    var ki = z ? window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : setTimeout : function (e) {
      return e();
    };
    ...
    function Li(e, t) {
      ...
      return "transition" === t ? a > 0 && (n = "transition", u = a, d = o.length) : "animation" === t ? c > 0 && (n = "animation", u = c, d = l.length) : d = (n = (u = Math.max(a, c)) > 0 ? a > c ? "transition" : "animation" : null) ? "transition" === n ? o.length : l.length : 0, {
        ...
        timeout: u,
        propCount: d,
        hasTransform: "transition" === n && Di.test(r[Ti + "Property"])
      };
    }
    ...
    function Ri(e, t) {
      ...
      if (!i(r) && !o(n._enterCb) && 1 === n.nodeType) {
        for (var a = r.css, s = r.type, c = r.enterClass, u = r.enterToClass, d = r.enterActiveClass, f = r.appearClass, p = r.appearToClass, h = r.appearActiveClass, g = r.beforeEnter, m = r.enter, y = r.afterEnter, b = r.enterCancelled, E = r.beforeAppear, _ = r.appear, w = r.afterAppear, T = r.appearCancelled, S = r.duration, C = Qt, A = Qt.$vnode; A && A.parent;) {
        ...
        if (!k || _ || "" === _) {
          ...
          var R = !1 !== a && !X,
            ...
            R && (Ii(n, I), Ii(n, M)), P.cancelled ? (R && Ii(n, x), N && N(n)) : L && L(n), n._enterCb = null;
          });
          e.data.show || ct(e, "insert", function () {
            var t = n.parentNode,
                r = t && t._pending && t._pending[e.key];
            r && r.tag === e.tag && r.elm._leaveCb && r.elm._leaveCb(), D && D(n, P);
          }), O && O(n), R && (Mi(n, x), Mi(n, M), xi(function () {
            Ii(n, x), P.cancelled || (Mi(n, I), F || (Fi($) ? setTimeout(P, $) : Oi(n, s, P)));
    ...
    function ji(e, t) {
      ...
      if (!o(n._leaveCb)) {
        ...
        var w = n._leaveCb = j(function () {
          n.parentNode && n.parentNode._pending && (n.parentNode._pending[e.key] = null), b && (Ii(n, u), Ii(n, d)), w.cancelled ? (b && Ii(n, c), g && g(n)) : (t(), h && h(n)), n._leaveCb = null;
        });
        m ? m(T) : T();
      }

      function T() {
        w.cancelled || (!e.data.show && n.parentNode && ((n.parentNode._pending || (n.parentNode._pending = {}))[e.key] = e), f && f(n), b && (Mi(n, c), Mi(n, d), xi(function () {
          Ii(n, c), w.cancelled || (Mi(n, u), E || (Fi(_) ? setTimeout(w, _) : Oi(n, s, w)));
        })), p && p(n, w), b || E || w());
      }
    }
        ...
        if (e !== t) {
          ...
          if (a(e.isAsyncPlaceholder)) o(t.asyncFactory.resolved) ? k(e.elm, t, n) : t.isAsyncPlaceholder = !0;else if (a(t.isStatic) && a(e.isStatic) && t.key === e.key && (a(t.isCloned) || a(t.isOnce))) t.componentInstance = e.componentInstance;else {
            ...
            i(t.text) ? o(g) && o(m) ? g !== m && function (e, t, n, r, a) {
              ...
              for (0; f <= h && p <= m;) {
                i(v) ? v = t[++f] : i(g) ? g = t[--h] : ar(v, y) ? (S(v, y, r, n, p), v = t[++f], y = n[++p]) : ar(g, E) ? (S(g, E, r, n, m), g = t[--h], E = n[--m]) : ar(v, E) ? (S(v, E, r, n, m), w && c.insertBefore(e, v.elm, c.nextSibling(g.elm)), v = t[++f], E = n[--m]) : ar(g, y) ? (S(g, y, r, n, p), w && c.insertBefore(e, g.elm, v.elm), g = t[--h], y = n[++p]) : (i(s) && (s = sr(t, f, h)), i(l = o(y.key) ? s[y.key] : T(y, t, f, h)) ? d(y, r, e, v.elm, !1, n, p) : ar(u = t[l], y) ? (S(u, y, r, n, p), t[l] = void 0, w && c.insertBefore(e, u.elm, v.elm)) : d(y, r, e, v.elm, !1, n, p), y = n[++p]);
              }

              f > h ? b(e, i(n[m + 1]) ? null : n[m + 1].elm, n, p, m, r) : p > m && _(t, f, h);
            }(f, g, m, n, u) : o(m) ? (o(e.text) && c.setTextContent(f, ""), b(f, null, m, 0, m.length - 1, n)) : o(g) ? _(g, 0, g.length - 1) : o(e.text) && c.setTextContent(f, "") : e.text !== t.text && c.setTextContent(f, t.text), o(h) && o(p = h.hook) && o(p = p.postpatch) && p(e, t);
          }
        }
      }
        ...
        if (!i(t)) {
          ...
          if (i(e)) u = !0, d(t, f);else {
            ...
            if (!p && ar(e, t)) S(e, t, f, null, null, s);else {
              if (p) {
                if (1 === e.nodeType && e.hasAttribute("data-server-rendered") && (e.removeAttribute("data-server-rendered"), n = !0), a(n) && k(e, t, f)) return C(t, f, !0), e;
    ...
    var Ui = {
      inserted: function inserted(e, t, n, r) {
        ...
        }) : Wi(e, t, n.context), e._vOptions = [].map.call(e.options, qi)) : ("textarea" === n.tag || Zn(e.type)) && (e._vModifiers = t.modifiers, t.modifiers.lazy || (e.addEventListener("compositionstart", zi), e.addEventListener("compositionend", Yi), e.addEventListener("change", Yi), X && (e.vmodel = !0)));
      },
    ...
    function Gi(e, t, n) {
      ...
      if (!i || Array.isArray(r)) {
        for (var o, a, s = 0, l = e.options.length; s < l; s++) {
          if (a = e.options[s], i) o = R(r, qi(a)) > -1, a.selected !== o && (a.selected = o);else if ($(qi(a), r)) return void (e.selectedIndex !== s && (e.selectedIndex = s));
        }
    ...
    var Qi = {
      ...
      show: {
        ...
        update: function update(e, t, n) {
          var r = t.value;
          !r != !t.oldValue && ((n = Ki(n)).data && n.data.transition ? (n.data.show = !0, r ? Ri(n, function () {
        ...
        updated: function updated() {
          ...
          e.length && this.hasMove(e[0].elm, t) && (e.forEach(ao), e.forEach(so), e.forEach(lo), this._reflow = document.body.offsetHeight, e.forEach(function (e) {
            if (e.data.moved) {
              var n = e.elm,
                  r = n.style;
              Mi(n, t), r.transform = r.WebkitTransform = r.transitionDuration = "", n.addEventListener(Si, n._moveCb = function e(r) {
    ...
    Cn.config.mustUseProp = $n, Cn.config.isReservedTag = Kn, Cn.config.isReservedAttr = Ln, Cn.config.getTagNamespace = Qn, Cn.config.isUnknownElement = function (e) {
      if (!z) return !0;
      if (Kn(e)) return !1;
    ...
    }, I(Cn.options.directives, Qi), I(Cn.options.components, co), Cn.prototype.__patch__ = z ? Hi : D, Cn.prototype.$mount = function (e, t) {
    ...
    var vo,
      ...
      return (vo = vo || document.createElement("div")).innerHTML = e, vo.textContent;
        ...
        Eo = g("address,article,aside,base,blockquote,body,caption,col,colgroup,dd,details,dialog,div,dl,dt,fieldset,figcaption,figure,footer,form,h1,h2,h3,h4,h5,h6,head,header,hgroup,hr,html,legend,li,menuitem,meta,optgroup,option,param,rp,rt,source,style,summary,tbody,td,tfoot,th,thead,title,tr,track"),
        _o = /^\s*([^\s"'<>\/=]+)(?:\s*(=)\s*(?:"([^"]*)"+|'([^']*)'+|([^\s"'=<>`]+)))?/,
        wo = /^\s*((?:v-[\w-]+:|@|:|#)\[[^=]+\][^\s"'<>\/=]*)(?:\s*(=)\s*(?:"([^"]*)"+|'([^']*)'+|([^\s"'=<>`]+)))?/,
    ...
    function sa(e, t) {
      Po = t.warn || Ir, Go = t.isPreTag || L, Vo = t.mustUseProp || L, qo = t.getTagNamespace || L;
      var n = t.isReservedTag || L;
      (function (e) {
        return !!e.component || !n(e.tag);
      }), Ho = Or(t.modules, "transformNode"), Uo = Or(t.modules, "preTransformNode"), Wo = Or(t.modules, "postTransformNode"), Bo = t.delimiters;
      var r,
          i,
          o = [],
      ...
      return function (e, t) {
        for (var n, r, i = [], o = t.expectHTML, a = t.isUnaryTag || L, s = t.canBeLeftOpenTag || L, l = 0; e;) {
          if (n = e, r && Oo(r)) {
            var c = 0,
              ...
              return c = r.length, Oo(u) || "noscript" === u || (n = n.replace(/<!\--([\s\S]*?)-->/g, "$1").replace(/<!\[CDATA\[([\s\S]*?)]]>/g, "$1")), jo(u, n) && (n = n.slice(1)), t.chars && t.chars(n), "";
            });
            ...
            if (p >= 0) {
              for (_ = e.slice(p); !(ko.test(_) || Co.test(_) || Mo.test(_) || Io.test(_) || (w = _.indexOf("<", 1)) < 0);) {
                p += w, _ = e.slice(p);
              }
            ...
            p < 0 && (E = e), E && T(E.length), t.chars && E && t.chars(E, l - E.length, l);
          }
        ...
        function S() {
          ...
          if (t) {
            ...
            for (T(t[0].length); !(n = e.match(Ao)) && (r = e.match(wo) || e.match(_o));) {
              r.start = l, T(r[0].length), r.end = l, i.attrs.push(r);
            }
      ...
      return function (e) {
        ...
        for (t = 0, n = c.length; t < n; t++) {
          if (r = i = c[t].name, o = c[t].value, Yo.test(r)) {
            if (e.hasBindings = !0, (a = fa(r.replace(Yo, ""))) && (r = r.replace(ta, "")), ea.test(r)) r = r.replace(ea, ""), o = xr(o), (l = Xo.test(r)) && (r = r.slice(1, -1)), a && (a.prop && !l && "innerHtml" === (r = S(r)) && (r = "innerHTML"), a.camel && !l && (r = S(r)), a.sync && (s = Wr(o, "$event"), l ? jr(e, '"update:"+(' + r + ")", s, null, !1, 0, c[t], !0) : (jr(e, "update:" + S(r), s, null, !1, 0, c[t]), k(r) !== S(r) && jr(e, "update:" + k(r), s, null, !1, 0, c[t])))), a && a.prop || !e.component && Vo(e.tag, e.attrsMap.type, r) ? Dr(e, r, o, c[t], l) : Lr(e, r, o, c[t], l);else if (zo.test(r)) r = r.replace(zo, ""), (l = Xo.test(r)) && (r = r.slice(1, -1)), jr(e, r, o, a, !1, 0, c[t], l);else {
              var u = (r = r.replace(Yo, "")).match(Zo),
                  d = u && u[1];
              l = !1, d && (r = r.slice(0, -(d.length + 1)), Xo.test(d) && (d = d.slice(1, -1), l = !0)), $r(e, r, i, o, d, l, a, c[t]);
            }
        ...
        if ("input" === e.tag) {
          ...
          if ((r[":type"] || r["v-bind:type"]) && (n = Fr(e, "type")), r.type || n || !r["v-bind"] || (n = "(" + r["v-bind"] + ").type"), n) {
            var i = Pr(e, "v-if", !0),
                ...
                s = Pr(e, "v-else-if", !0),
                l = ga(e);
            ca(l), Nr(l, "type", "checkbox"), la(l, t), l.processed = !0, l["if"] = "(" + n + ")==='checkbox'" + o, ua(l, {
              exp: l["if"],
              block: l
            });
            var c = ga(e);
            Pr(c, "v-for", !0), Nr(c, "type", "radio"), la(c, t), ua(l, {
              exp: "(" + n + ")==='radio'" + o,
              block: c
            });
            var u = ga(e);
            return Pr(u, "v-for", !0), Nr(u, ":type", n), la(u, t), ua(l, {
              exp: i,
              block: u
      ...
      directives: {
        model: function model(e, t, n) {
          ...
          if ("select" === o) !function (e, t, n) {
            ...
            r = r + " " + Wr(t, "$event.target.multiple ? $$selectedVal : $$selectedVal[0]"), jr(e, "change", r, null, !0);
          }(e, r, i);else if ("input" === o && "checkbox" === a) !function (e, t, n) {
            var r = n && n.number,
                i = Fr(e, "value") || "null",
                o = Fr(e, "true-value") || "true",
                a = Fr(e, "false-value") || "false";
            Dr(e, "checked", "Array.isArray(" + t + ")?_i(" + t + "," + i + ")>-1" + ("true" === o ? ":(" + t + ")" : ":_q(" + t + "," + o + ")")), jr(e, "change", "var $$a=" + t + ",$$el=$event.target,$$c=$$el.checked?(" + o + "):(" + a + ");if(Array.isArray($$a)){var $$v=" + (r ? "_n(" + i + ")" : i) + ",$$i=_i($$a,$$v);if($$el.checked){$$i<0&&(" + Wr(t, "$$a.concat([$$v])") + ")}else{$$i>-1&&(" + Wr(t, "$$a.slice(0,$$i).concat($$a.slice($$i+1))") + ")}}else{" + Wr(t, "$$c") + "}", null, !0);
          }(e, r, i);else if ("input" === o && "radio" === a) !function (e, t, n) {
            var r = n && n.number,
                i = Fr(e, "value") || "null";
            Dr(e, "checked", "_q(" + t + "," + (i = r ? "_n(" + i + ")" : i) + ")"), jr(e, "change", Wr(t, i), null, !0);
    ...
    function wa(e, t) {
      e && (ya = _a(t.staticKeys || ""), ba = t.isReservedTag || L, function e(t) {
    ...
    function Oa(e) {
      ...
      if (e.modifiers) {
        ...
        for (var s in e.modifiers) {
          if (Ma[s]) o += Ma[s], Aa[s] && a.push(s);else if ("exact" === s) {
            var l = e.modifiers;
    ...
    var La = {
      ...
      cloak: D
        ...
        Na = function Na(e) {
      this.options = e, this.warn = e.warn || Ir, this.transforms = Or(e.modules, "transformCode"), this.dataGenFns = Or(e.modules, "genData"), this.directives = I(I({}, La), e.directives);
    ...
    function Ha(e, t) {
      ...
      if (e.attrs && (n += "attrs:" + za(e.attrs) + ","), e.props && (n += "domProps:" + za(e.props) + ","), e.events && (n += Ia(e.events, !1) + ","), e.nativeEvents && (n += Ia(e.nativeEvents, !0) + ","), e.slotTarget && !e.slotScope && (n += "slot:" + e.slotTarget + ","), e.scopedSlots && (n += function (e, t, n) {
    ...
    function Wa(e, t) {
      ...
      if (e["if"] && !e.ifProcessed && !n) return Pa(e, t, Wa, "null");
      if (e["for"] && !e.forProcessed) return Ba(e, t, Wa);
      var r = "_empty_" === e.slotScope ? "" : String(e.slotScope),
          i = "function(" + r + "){return " + ("template" === e.tag ? e["if"] && n ? "(" + e["if"] + ")?" + (Ga(e, t) || "undefined") + ":undefined" : Ga(e, t) || "undefined" : Ra(e, t)) + "}",
          o = r ? "" : ",proxy:true";
  ...
  !function (e) {
    ...
    !function (e) {
      ...
      if (0 === l && 0 === c) return 4;
      {
        ...
        switch (a) {
          case t.BASIC:
            Math.abs(l) > Math.abs(c) ? (N = l > 0 ? 1 : 3, r(e, n.i, n.j, N, i) && (N = c > 0 ? 2 : 0)) : (N = c > 0 ? 2 : 0, r(e, n.i, n.j, N, i) && (N = l > 0 ? 1 : 3)), r(e, n.i, n.j, N, i) && (N = 4);
            break;

          case t.D_STAR_LITE:
            {
              var b = function b(e) {
                return [Math.min(T(e), S(e)) + x(g, e) + _r8, Math.min(T(e), S(e))];
              };

              var E = function E(e) {
                T(e) !== S(e) ? (e.key = b(e), O(e)) : function (e) {
              ...
              var O = function O(e) {
                ...
                try {
                  for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
                    ...
                    if (I(e, _t15)) return void (_t15.key = e.key);
                  }
                } catch (err) {
                  _iterator7.e(err);
                } finally {
              ...
              var L = function L() {
                ...
                try {
                  for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
                    ...
                    (void 0 === e || M(_t16.key, e.key) < 0) && (e = _t16);
                  }
                } catch (err) {
                  _iterator9.e(err);
                } finally {
              ...
              g = {
                ...
                (function () {
                  ...
                  w(m, 0);
                  var n = m;
                  n.key = [x(g, m), 0], f.push(n);
                })(), function () {
                  for (; M(L().key, b(g)) < 0 || S(g) > T(g);) {
                    var _e18 = L(),
                        _n14 = _e18,
                        _r9 = _e18.key,
                        _i6 = b(_n14);

                    if (M(_r9, _i6) < 0) _n14.key = _i6, O(_n14);else if (T(_n14) > S(_n14)) {
                      _(_n14, S(_n14)), D(_n14);

                      var _iterator11 = _createForOfIteratorHelper(A(_n14)),
                          _step11;

                      try {
                        for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
                          var _e19 = _step11.value;
                          I(_e19, m) || w(_e19, Math.min(S(_e19), k(_e19, _n14) + T(_n14))), E(_e19);
                        }
                      } catch (err) {
                        _iterator11.e(err);
                      } finally {
                      ...
                      try {
                        for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
                          ...
                          if ((S(_i7) === k(_i7, _n14) + _e20 || S(_i7) === _t13 && (k(_i7, _n14) === _t13 || _e20 === _t13)) && !I(_i7, m)) {
                            var _e21 = void 0;

                            var _iterator13 = _createForOfIteratorHelper(C(_i7)),
                                _step13;
                ...
                for (; !I(g, m);) {
                  ...
                  var _iterator14 = _createForOfIteratorHelper(C(g)),
                      _step14;
        ...
        4 !== N && (u.a.addDirectionToPath(n, N, 3), void 0 === n.path && (n.path = []), 3 === n.path.length && n.path[0] === n.path[2] && o.a.isDirectionsOpposed(n.path[0], n.path[1]) && (N = 4));

        var _$ = p.a.now() - s;

        return _$ > 10 && console.debug("Path found in: " + _$), N;
      }
    };
  }(r || (r = {}));
}, function (e, t, n) {
  ...
  !function (e) {
    ...
    function v(e, r, i, o, s, c) {
      ...
      if (0 === w.length) d(o.closingTimeout);else if (1 === w.length && void 0 === w[0].message) {
        if (void 0 === w[0].inputType) n = function n() {
          ...
          _e30.id = "userInput", _.appendChild(_e30);
        }
      } else {
        ...
        try {
          var _loop = function _loop() {
            ...
            void 0 !== e.message && (t.innerText = e.message), t.onclick = function () {
              T(e);
            }, t.classList.add("l4wDialogEdge"), _.appendChild(t);
          };
  ...
  function g(e) {
    ...
    } else r = v(), t = E.bind(null, r), n = function n() {
      r.parentNode.removeChild(r);
    };
  ...
  var a = /*#__PURE__*/function (_r$a4) {
    ...
    _createClass(a, [{
      ...
      value: function mainGameLoop_pre() {
        ...
        return this.requestedNewFrame && (this.requestedNewFrame = !1), this.newDrawArea = this.getRedrawArea(e), this.redrawArea = o.a.mergeRectangles(this.oldDrawArea, this.newDrawArea), this.grid.clear(this.context, this.redrawArea), !0;
      }
    }, {
      key: "mainGameLoop_post",
      value: function mainGameLoop_post() {
      ...
      key: "renderPointer",
      value: function renderPointer() {
        void 0 !== this.pointer && (this.context.save(), this.context.globalAlpha = .4, this.context.fillStyle = i.a.Color.YELLOW, this.context.fillRect(this.pointer.i * this.grid.cellW, this.pointer.j * this.grid.cellH, this.grid.cellW, this.grid.cellH), this.context.restore());
      }
    }, {
      key: "select",
  ...
  var o = /*#__PURE__*/function (_r$a5) {
    ...
    function o(e, t, n, r) {
      ...
      _this3 = _super6.call(this, e, t, n), _this3.overriddenProps = void 0 !== r ? r : new Map();
      return _this3;
    }
    ...
    _createClass(o, [{
      key: "deferredInit",
      value: function deferredInit(e) {
        switch (i.a.isEmpty(this.overriddenProps) || (e = i.a.mergeMaps(this.overriddenProps, e)), _get(_getPrototypeOf(o.prototype), "deferredInit", this).call(this, e), this.gridType) {
          case r.b.mapper:
      ...
      value: function getBoundariesX(e, t, n, r) {
        return void 0 !== n ? void 0 !== r ? {
          ...
          min: n.i,
          max: n.i
        } : _get(_getPrototypeOf(o.prototype), "getBoundariesX", this).call(this, e, t);
      }
    }, {
      key: "getBoundariesY",
      value: function getBoundariesY(e, t, n, r) {
        return void 0 !== n ? void 0 !== r ? {
          ...
          min: n.j,
          max: n.j
        } : _get(_getPrototypeOf(o.prototype), "getBoundariesY", this).call(this, e, t);
      }
    }, {
  ...
  var i = /*#__PURE__*/function (_r$a6) {
    ...
    _createClass(i, [{
      ...
      value: function getRedrawArea(e) {
        ...
        return _get(_getPrototypeOf(i.prototype), "getRedrawArea", this).call(this, e, t);
      }
    }, {
      key: "select",
      value: function select(e, t) {
        _get(_getPrototypeOf(i.prototype), "select", this).call(this, e, t), this.requestedNewFrame = !0;
      }
    }]);
  ...
  n.r(t), n.d(t, "TilesetterPage", function () {
    return m;
  });
  var r = n(8),
      i = n(29),
  ...
  var v = /*#__PURE__*/function (_u$a) {
    ...
    function v(e, t, n) {
      ...
      _this4 = _super8.call(this, e), _this4.renderingConfiguration.enableSelection = !1, _this4.changeTileEditMode(t), _this4.map = p.a.getEmptyMap("blocks"), _this4.map.tileset = p.a.getTileset(), _this4.map.width = _this4.getSceneWidth(), _this4.map.height = _this4.getSceneHeight(), _this4.map.tileset.imageWidth = _this4.getSceneWidth(), _this4.map.tileset.imageHeight = _this4.getSceneHeight(), n(_assertThisInitialized(_this4));
      return _this4;
    }
    ...
    _createClass(v, [{
      ...
      value: function changeTileEditMode(e) {
        switch (this.toggleBlocks(!1), this.toggleOnTops(!1), e) {
          case a.a.TileEditMode.BLOCKS:
            this.toggleBlocks(!0);
            break;

          case a.a.TileEditMode.ONTOP:
            this.toggleOnTops(!0);
            break;
      ...
      value: function selectPrecisely(e, t, n, r) {
        _get(_getPrototypeOf(v.prototype), "select", this).call(this, e, t);
        ...
        var c = d.a.cellToGid({
          ...
          j: t
            ...
            u = d.a.getMapBlocks(this.map, c);

        switch (i) {
          case 0:
            d.a.isBlockDirectionBlocked(u, f.a.UP) ? u ^= f.a.UP : u |= f.a.UP;
            break;

          case 1:
            d.a.isBlockDirectionBlocked(u, f.a.DOWN) ? u ^= f.a.DOWN : u |= f.a.DOWN;
            break;

          case 2:
            d.a.isBlockDirectionBlocked(u, f.a.LEFT) ? u ^= f.a.LEFT : u |= f.a.LEFT;
            break;

          case 3:
            d.a.isBlockDirectionBlocked(u, f.a.RIGHT) ? u ^= f.a.RIGHT : u |= f.a.RIGHT;
            break;

          case 4:
            d.a.isBlockDirectionBlocked(u, f.a.ALL) ? u ^= f.a.ALL : u |= f.a.ALL;
            break;
      ...
      value: function selectLeft(e, t) {
        ...
        h.a.isEmpty(r) && (r = 0), r < 4 && (this.map.tileset.onTop[n] = r + 1, m.changeEditState(!0));
      }
    }, {
      key: "selectRight",
      value: function selectRight(e, t) {
        ...
        var n = d.a.cellToGid({
          ...
          j: t
            ...
            r = this.map.tileset.onTop[n];
        h.a.isEmpty(r) && (r = 0), r > 0 && (this.map.tileset.onTop[n] = r - 1, m.changeEditState(!0));
      }
    }]);
  ...
  !function (e) {
    ...
    function r(e) {
      ...
      $.ajax({
        url: "/data/tileset/" + n,
        type: a.a.RequestType.GET,
        contentType: a.a.MimeType.JSON,
        success: function success(n) {
          var r = t.map.tileset.imageData;
          t.map.tileset = n, t.map.tileset.imageData = r, h.a.isEmpty(t) || (void 0 === t.map.tileset.blocks && (t.map.tileset.blocks = []), void 0 === t.map.tileset.onTop && (t.map.tileset.onTop = []), t.map.blocks = t.map.tileset.blocks), t.requestedNewFrame = !0, e(!0);
        },
    ...
    e.start = function (e, r, i) {
      new y.a(e, function (o) {
        new v(o, r, function (s) {
          !function (e, n) {
            var r = new Map();
            l.a.init(e, n, r, c.b, c.b, function (e, n, r, i, o) {
              switch (m.getEditMode()) {
                case a.a.TileEditMode.BLOCKS:
                  (h.a.isEmpty(o) || o === l.a.MouseButtons.LEFT) && (t.selectPrecisely(e, n, r, i), m.changeEditState(!0));
                  break;

                case a.a.TileEditMode.ONTOP:
                  h.a.isEmpty(o) || o === l.a.MouseButtons.LEFT ? t.selectLeft(e, n) : o === l.a.MouseButtons.RIGHT && t.selectRight(e, n);
                  break;
              ...
              (h.a.isEmpty(r) || r === l.a.MouseButtons.LEFT) && t.selectEnd(e, n);
            }, function (e, n, r) {
              (h.a.isEmpty(r) || r === l.a.MouseButtons.LEFT) && t.selectEnd(e, n), t.updatePointer(e, n);
            }, function (e, n) {
              t.updatePointer(e, n);
            }, c.b, c.b, c.b, function (e, n) {
              t.cleanSelection();
            }, c.b, c.b);
          }(e, o), t = s, t.start(e), n(r), i();
        });
      }, b.b.tilePicker);
    }, e.setTileEditMode = n, e.loadTile = function (e, n) {
      var i = document.getElementById("canvasTile"),
          a = i.getContext("2d"),
          s = document.getElementById("canvasSelector");
      a.clearRect(0, 0, i.width, i.height), o.a.load(e, E.a.TILE, function (e) {
        var o = new Image();
        o.src = e.src, document.getElementById("tilePanel").style.height = o.naturalHeight + "", i.height = o.naturalHeight, i.width = o.naturalWidth, s.height = o.naturalHeight, s.width = o.naturalWidth, a.drawImage(e, 0, 0), r(function (e) {
          t.map.tileset.imageData = o, n(e, o.naturalWidth, o.naturalHeight);
        });
      });
    ...
    e.PAGE_TITLE = document.title, e.start = function () {
      s.a.check(), new r.a({
        ...
        for (var _n23 = 0; _n23 < e.length; _n23++) {
          var _r17 = document.createElement("option");

          _r17.value = e[_n23], _r17.label = e[_n23], t.appendChild(_r17);
        }

        g.start(document.getElementById("canvasSelector"), n(), function () {
          var e = document.getElementById("tiles").value;
          g.loadTile(e, function (e, t, n) {});
        });
      });
    }, e.loadNews = t, e.changeTile = function () {
      var e = document.getElementById("tiles").value;
      g.loadTile(e, function (t, n, r) {
        t ? (g.updateSize(n, r), l(!1)) : console.error("Tile loading failed: " + e);
      });
    }, e.getEditMode = n, e.changeTileEditMode = function () {
      g.setTileEditMode(n()), e.changeEditState(!1);
    }, e.save = function () {
      g.saveTilesetData(function (t) {
        t ? e.changeEditState(!1) : console.error("Saving failed");
      });
    }, e.reload = function () {
      g.loadTilesetData(function (t) {
